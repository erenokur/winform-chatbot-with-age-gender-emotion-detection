...
{
    public partial class DialogBubbles : UserControl
    {
        public static MessageControl messageControl1 = new MessageControl();
        public DialogBubbles()
        {
            InitializeComponent();
            ...
            this.UpdateStyles();
            Load += Form1_Load;
            this.Controls.Add(messageControl1);
        }
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            /* messageControl1.Add("Size nasıl yardımcı olabilirim ", MessageControl.BubblePositionEnum.Right);
             messageControl1.Add("Bu Avm'ye ilk defa geliyorum bana tanıtabilir misin?.", MessageControl.BubblePositionEnum.Left);
             messageControl1.Add("12 Haziran 2015 tarihinde Novaland Outlet Konya , şehrin ilk outlet alışveriş merkezi olarak kapılarını açtı.", MessageControl.BubblePositionEnum.Right);
             messageControl1.Add(" Açıldığı günden itibaren, ziyaretçilerine modaya, markaya ve kaliteye uygun fiyata ulaşma imkanı sunarak, şehirde yeni bir çekim merkezi oluşturmayı başardı. ", MessageControl.BubblePositionEnum.Right);
             messageControl1.Add("Modern, sade, ferah bir ortamda alışveriş keyfi sunan Novaland Outlet Konya , ulusal ve uluslararası markaları ziyaretçileriyle buluşturuyor.", MessageControl.BubblePositionEnum.Right);
             messageControl1.Add("127 marka haftanın 7 günü 10:00 22:00 saatleri arasında hizmet vermektedir.  ", MessageControl.BubblePositionEnum.Right);
             messageControl1.Add("Kampanyalardan bahseder misin? ", MessageControl.BubblePositionEnum.Right);
             messageControl1.Add("Meteorolojiden aldığım bilgiye göre önümüzdeki hafta karlı olacak.", MessageControl.BubblePositionEnum.Left);
             messageControl1.Add("Koton'da kışlık mont kampanyaları vardır ilgilenmek ister misiniz?.", MessageControl.BubblePositionEnum.Left);
             messageControl1.Add("ilk üründe yüzde 10 ikinci üründe yüzde 50 indirim yapılmaktadır.", MessageControl.BubblePositionEnum.Left);
             messageControl1.Add("Teşekkür ederim.", MessageControl.BubblePositionEnum.Right);
             messageControl1.Add("Rica ederim, size hizmet için her zaman buradayım.", MessageControl.BubblePositionEnum.Left);*/
